...
git clone https://github.com/lloyd18/luci-app-npc.git package/lean/luci-app-npc
#mosdns
git clone https://github.com/miniers/openwrt-mosdns.git package/lean/mosdns

#fstools-support-extroot-for-non-MTD-rootfs
mkdir -p ./package/system/fstools/patches
cp -rf ../PATCH/system/0001-fstools-support-extroot-for-non-MTD-rootfs_data.patch ./package/system/fstools/patches
